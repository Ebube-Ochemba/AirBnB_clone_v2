...
class HBNBCommand(cmd.Cmd):
    ...
    def dict_creator(self, arg_list):
        ...
        for arg in arg_list:
            ...
            elif '.' in value:  # Handling float value
                try:
                    value = float(value)
                except ValueError:
                    continue
            else:  # Handling integer value
                try:
                    value = int(value)
                except ValueError:
                    continue
    ...
    def do_all(self, args):
        ...
        if args:
            ...
            # Use the 'all' method of DBStorage to query objects
            objects = storage.all(HBNBCommand.classes[args])
            for obj_id, obj in objects.items():
                print_list.append(str(obj))
        else:
            # Use the 'all' method of DBStorage without specifying class
            objects = storage.all()
            for obj_id, obj in objects.items():
                print_list.append(str(obj))
